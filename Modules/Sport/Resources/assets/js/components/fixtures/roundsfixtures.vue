  ...
  <div class="app-container">
    <!-- Note that row-key is necessary to get a correct row order. -->
      <div class="filter-container">
          <router-link :to="'/fixtures/add/'+sportId+'/'+roundId">
...
<script>
import { fetchFixtureListBySportAndRound, updateFixtureStatus } from '@/api/fixture';
...
export default {
  ...
  methods: {
    async getList() {
      ...
      const sport_id = this.$route.params && this.$route.params.sid;
      this.sportId = sport_id;

      const round_id = this.$route.params && this.$route.params.rid;
      this.roundId = round_id;

      const { data } = await fetchFixtureListBySportAndRound(sport_id,round_id);
